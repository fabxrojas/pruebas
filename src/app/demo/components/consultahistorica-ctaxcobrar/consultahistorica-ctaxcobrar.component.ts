...
export class ConsultahistoricaCtaxcobrarComponent implements OnInit{
  ...
  obtenerFacturaPendiente(): void {
    ...
    const ruc = this.textoBuscar.trim(); // Esta linea permite obtener el RUC del filtro
  ...
  generarPDFPendiente(dataReporte: agregar_Pago[]): void {
    ...
    const headers = [
      [
        ...
        // rowspan permite agrupar celdas
        // tableHeader permite aplicar estilos a los encabezados
    ...
    // Agrupamos por RUC
    const groupedData = {}; // Objeto para agrupar los datos por RUC
    // Iteramos sobre los datos de ayudapago
    ...
    const formatNumber = (num) => {
      ...
      //console.log("metodo formatear numero");
    ...
    // Agregar los datos agrupados al cuerpo de la tabla
    ...
    const docDefinition = {
      ...
      styles: {
        ...
        total: {
          bold: true, // Estilo para el total
          fontSize: 6,
          alignment: 'right',
        },
      },
