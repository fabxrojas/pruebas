...
import { DocDocPendCtaxCobrar } from '../../model/ConsultaDocPorPago';
...
export class ConsultaDocPorPagoComponent implements OnInit {
    ...
    consultaDocPorPagoList: DocDocPendCtaxCobrar[] = [];
    ...
    searchPerformed: boolean = false; /*indica si ya se ejecutó una búsqueda.*/
    ...
    buscar(): void {
        ...
        if (filtro === '') { //Si está vacío, lanza un toast de advertencia.
    ...
    initForm(): void {
        this.consultaDocPorPagoForm = this.fb.group({ /*Inicializar el formulario reactivo con formbuilder*/
            ban01Empresa: [
